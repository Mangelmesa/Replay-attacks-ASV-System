...
%% Generamos muestras del SSS entre dos frecuencias f1 y f2 para tiempo T
f1 = 200; %200-850-1500           % start frequency
f2 = 17200; %17200-13100-9000     % end frequency
T = 10;    % time duration
...
% Separamos las respuestas al impulso de alto orden de las de bajo orden
...
[s,fs]=audioread('PA_T_0000001.flac');
s_HH=real(conv2(s,Hm,'same'));
s_HH=mean(s_HH,2);
s_HH_norm=real(s_HH/max(abs(s_HH)));
sound(s_HH,fs)

% Hm_perfect=Hm;
% save('Hm_perfect.mat','Hm_perfect');

% Hm_High=Hm;
% save('Hm_High.mat','Hm_High');

% Hm_Low=Hm;
% save('Hm_Low.mat','Hm_Low');
